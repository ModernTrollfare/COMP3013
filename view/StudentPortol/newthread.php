...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Create new forum thread</title>
          ...
          <div class="row">
            ...
            <div class="span7">
              <form method="POST" action="newAction.php">
                ...
                <input name="title" id="title" required="" type="text"></input>
                <label for="content">Contents</label>
                <textarea name="content" id="content" required="" type="text"  style="width:100%;height:150px;resize:none"></textarea>
                <button class="btn" type="submit">Submit New Post</button>
              </form>
            </div>
          </div>
          </div>
