      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          ...
          <form class="form-signin" action="enrAction.php" method="POST">
              ...
              <br></br>    
              <button class="span3 btn btn-lg btn-primary btn-block" type="submit">Enrol</button>
          </form>
          <br></br>
          ...
          <form class="form-signin" action="unrAction.php" method="POST">
              ...
              <input type="name" id="stuid" name="stuid" class="form-control" placeholder="Student ID" required="" autofocus="">         
              <br></br>    
              <button class="span3 btn btn-lg btn-primary btn-block" type="submit">Unenrol</button>
          </form>
        </div><!--/span-->
      </div><!--/row-->
